...
function getaddressInfo(){	
	  ...
	  //建立好Get連接與送出請求
		var url="<%=request.getContextPath()%>/spot/Spot_Servlet?action=address&con="+document.getElementsByName("country")[0].value+"&dis="+document.getElementsByName("district")[0].value;
...
<body onload="load();changeSelect()" onunload="GUnload()">
<div class="form-group">
	<label class="col-sm-2 control-label"></label>
	<div class="col-sm-6">
		<input id="address" name="spotaddress" placeholder="輸入地址" maxlength="75" class="form-control" type="text" value="${SpotVO.spotaddress }" onclick="getaddressInfo();" onchange="addressGps();" />
		<input id="inLat" name="spotlat" type="hidden"/>
		<input id="inLng" name="spotlong" type="hidden"/>
	</div>	
</div>
<div class="form-group">
	<label class="col-sm-2 control-label"></label>
