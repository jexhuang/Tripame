...
<div class="container">
		...
		<ol class="breadcrumb" style="background-color: rgb(66, 139, 202)">
			...
			<li class="active" style="color: white;">更新交通管理</li>
		</ol>	
	...
	<form class="form-horizontal" action="<%=request.getContextPath() %>/traffic/traffic.do" method=post>
	<br>
		<div class="form-group">
			<label class="col-sm-2 control-label">編號</label>
			<div class="col-sm-5">
				<input type="text" name="traname" value="${trafficVO.trano }" class="form-control" maxlength="20" readonly>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">名稱</label>
			<div class="col-sm-5">
				<input type="text" name="traname" value="${trafficVO.traname }" class="form-control" maxlength="20">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input type="text" name="traaddress" value="${trafficVO.traaddress }" class="form-control" maxlength="75">				
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">電話</label>
			<div class="col-sm-5">
				<input type="text" name="traphone" value="${trafficVO.traphone }" class="form-control" maxlength="20">
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">官網</label>
			<div class="col-sm-5">			
				<input type="text" name="trasite" value="${trafficVO.trasite }" class="form-control" maxlength="150">
			</div>
		</div>
		<div class="form-group">
		...
		<input type="hidden" name="trano" value="${trafficVO.trano }">
