...
<body>
	<div class="container" style="margin-top:-30px;">
		...
		<ol class="breadcrumb" style="background-color: rgb(66, 139, 202)">
			...
			<li class="active" style="color: white;">新增套裝行程</li>
		</ol>
		...
		<form class="form-horizontal" role="form" action="<%=request.getContextPath()%>/travel/TravelServlet" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="from" name="begin" class="form-control" value="${begin}"/>
				</div>
				<label class="col-sm-1 control-label" for="end">結束日期</label>
				<div class="col-sm-3">
					<input type="text" id="to" name="end" class="form-control"  value="${end}"/>
				</div>
			</div>
			<br>
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="limit" name="limit" value="${travelvo.travellimit}" class="form-control" maxlength="10"/>
				</div>
			</div>
			<br>
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="price" name="price" value="${travelvo.travelprice}" maxlength="10"
						class="form-control" />
				</div>
			</div>
			<br>
			<div class="form-group">
				<label class="col-sm-3 control-label" for="name">行程名稱:</label>
				<div class="col-sm-7">
					<input type="text" id="name" placeholder="輸入行程名稱" name="name"
			...
			<div class="form-group">
				...
				<select name="status" class="form-control">
					<option value="待上架" ${(travelvo.travelstatus=='待上架')?'selected':''}>待上架</option>
					<option value="上架中" ${(travelvo.travelstatus=='上架中')?'selected':''}>上架中</option>
					<option value="已下架" ${(travelvo.travelstatus=='已下架')?'selected':''}>已下架</option>
				</select>
				</div>
			</div>
			<div class="form-group">
