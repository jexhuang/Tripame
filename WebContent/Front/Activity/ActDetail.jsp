		...
		<div class="col-md-12 column">			
			<div class="col-md-8">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-8">
								<table class="table table-hover">
									<tr>
										...
										<td>${actVO.actcon }${adVO.acttown }</td>
									</tr>
									<tr>
										<th>名稱:</th>
										<td style="color:#0080FF;"><b>${actVO.actname }</b></td>
									</tr>
									<tr>
										<th>電話:</th>
									...
									<tr>
										<th>地址:</th>
										<td>${actVO.actaddress }</td>
									</tr>
									<tr>
										<th>官網:</th>
										<td><a href="${(actVO.actsite=='無')?'#':actVO.actsite}">${actVO.actsite }</a></td>
									</tr>
									<tr>
										<th>開始日期:</th>
							...
							<div class="col-md-4">
								<img class="img-thumbnail" style="width:200px;height:200px" src="<%=request.getContextPath()%>/act/ActList_Img?actno=${actVO.actno}">
							</div>							
						</div>
					</div>
				</div>
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp${actVO.actcontent }
					</div>
				</div>
