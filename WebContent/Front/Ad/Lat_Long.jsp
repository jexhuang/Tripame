...
function getaddressInfo(){	
	...
	function load() {
		if (GBrowserIsCompatible()) {
			...
			var myLatLng = new GLatLng(${advo.adlat}, ${advo.adlong});
...
<body onload="load()" onunload="GUnload()">
	<input id="address" name="adaddress" placeholder="輸入地址"
		value="${advo.adaddress}" class="form-control" type="text" size="30" maxlength="75"
		onclick="getaddressInfo();" onchange="addressGps();" ${(advo.adstatus=='請修改')?'':'disabled'}
		 />
	<input id="inLat" name="adLat" type="hidden" size="20" value="" />
	<input id="inLng" name="adLng" type="hidden" size="20" value="" />
	<div id="my_map" style="width: 600px; height: 350px"></div>
</body>
</html>